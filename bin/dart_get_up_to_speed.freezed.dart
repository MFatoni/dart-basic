...
class _$_Person2 extends _Person2 {
  const _$_Person2({required this.name}) : super._();
...
abstract class _Person2 extends Person2 {
  const factory _Person2({required final String name}) = _$_Person2;
  const _Person2._() : super._();
...
class _$_Failure extends _Failure {
  const _$_Failure(this.errorMessage) : super._();
